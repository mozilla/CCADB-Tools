...
const OID_REGISTRY: &[OidEntry] = &[
    ...
    OidEntry {
        sn: "Email",
        ln: "emailAddress",
        nid: Nid::EmailAddress,
        oid: OBJ_EMAIL,
    },
    OidEntry {
        sn: "RSA-ENC",
        ln: "rsaEncryption",
        nid: Nid::RsaEncryption,
        oid: OBJ_RSAENCRYPTION,
    },
    OidEntry {
        sn: "RSA-SHA1",
        ln: "sha1WithRSAEncryption",
        nid: Nid::RsaSha1,
        oid: OBJ_RSASHA1,
    },
    OidEntry {
    ...
    OidEntry {
        sn: "privateKeyUsagePeriod",
        ln: "X509v3 Private Key Usage Period",
        nid: Nid::PrivateKeyUsagePeriod,
        oid: OBJ_PKUP,
    },
    OidEntry {
        sn: "subjectAltName",
        ln: "X509v3 Subject Alternative Name",
        nid: Nid::SubjectAltName,
        oid: OBJ_SAN,
    },
    OidEntry {
        sn: "basicConstraints",
        ln: "X509v3 Basic Constraints",
        nid: Nid::BasicConstraints,
        oid: OBJ_BC,
    },
    OidEntry {
        sn: "certificatePolicies",
        ln: "X509v3 Certificate Policies",
        nid: Nid::CertificatePolicies,
        oid: OBJ_CPOL,
    },
    OidEntry {
        sn: "authorityKeyIdentifier",
        ln: "X509v3 Authority Key Identifier",
        nid: Nid::AuthorityKeyIdentifier,
        oid: OBJ_AKI,
    },
];
