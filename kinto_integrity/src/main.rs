...
mod tests {
    ...
    const goals: &str = "MH8xCzAJBgNVBAYTAkVVMScwJQYDVQQKEx5BQyBDYW1lcmZpcm1hIFNBIENJRiBBODI3NDMyODcxIzAhBgNVBAsTGmh0dHA6Ly93d3cuY2hhbWJlcnNpZ24ub3JnMSIwIAYDVQQDExlDaGFtYmVycyBvZiBDb21tZXJjZSBSb290";
    #[test]
    fn comeonlady() {
        let b = base64::decode(goals).unwrap();
        let (d, e) = der_parser::parse_der(&b).unwrap();
        println!("{:?}", e);
...
//    fn parse_rdn(i:&[u8]) -> Result<RelativeDistinguishedName> {
//        parse_der_struct!(
//            i,
//            TAG DerTag::Set,
