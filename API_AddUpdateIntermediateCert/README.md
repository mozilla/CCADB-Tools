...
* Description: Please grant our CA access to the CCADB API.

Upon receipt of the API details (HOST_URL, CONSUMER_KEY, CONSUMER_SECRET, etc.) from the CCADB Admin, complete the authentication process:
